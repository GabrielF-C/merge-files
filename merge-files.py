...
def main(input_file_paths: list, input_extension: str, output_file_path: str, output_extension: str):
  ...
  output_file = preprocess_output_file(output_file_path, output_extension)
...
def get_backup_path(output_file_path: str):
  return f"_{output_file_path}"

def get_backup_backup_path(output_file_path: str):
  return f"__{output_file_path}"

def preprocess_output_file(output_file_path: str, output_extension: str):
  ...
  print("Old output file will be prefixed with an underscore (older backup will be overwritten)")

  output_backup_path = get_backup_path(output_file_path)
  output_backup_backup_path = get_backup_backup_path(output_file_path)
...
def restore_output_backup(output_file_path: str):
...
def postprocess_output_file(output_file_path: str):
  print("Cleaning up")
...
if __name__ == '__main__':
  main(args.inputs, args.input_extension, args.output, args.output_extension)